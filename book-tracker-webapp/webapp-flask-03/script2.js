    ...
    books.forEach((book, index) => {
        ...
        const bookItem = `
            <div class="book-item">
                ...
                <div class="progress">${progressBar}</div> <br>
...
completedBooksButton.addEventListener('click', function() {
    window.location.href = '/completed_books';
});

const favoriteBooksButton = document.getElementById('favorite-books-button');
favoriteBooksButton.addEventListener('click', function() {
    window.location.href = '/favorite_books';
});
