...
entry1 = tk.Entry(root, textvar = Fullname, font = (14), borderwidth=2, width = 40)
...
entry2 = tk.Entry (root, textvar = Email, font = (14), borderwidth=2, width = 40) 
...
list1 = ['CSE','MECH','ENTC','CIVIL','INFT']
c=StringVar()
