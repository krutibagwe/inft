...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("images/newcust.jpg"));
                Image i3 = i1.getImage().getScaledInstance(450, 275,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(580,80,450,275);
                add(l1);
		...
		JLabel lblCountry = new JLabel("Email Id :");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (s1.isEmpty() || s2.isEmpty() || s3.isEmpty() || s4 == null || s5.isEmpty() || s6.isEmpty() || s7.isEmpty() || s8.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please fill all the details.");
        } else if (!s3.matches("^[a-zA-Z]*$")) {
		...
		btnNewButton.setBounds(260, 430, 120, 30);
		...
		btnExit.setBounds(100, 430, 120, 30);
