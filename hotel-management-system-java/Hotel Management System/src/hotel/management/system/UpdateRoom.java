	...
	public UpdateRoom() throws SQLException {
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Conn c = new Conn();
                                ...
                                while(rs1.next()){
                                    txt_Room.setText(rs1.getString("number"));    
                                }
                            }catch(Exception ee){}
                            try{
                                String s2 = c1.getSelectedItem();
                                Conn c  = new Conn();
                                ResultSet rs2 = c.s.executeQuery("select * from room where roomnumber = "+s2);
                                while(rs2.next()){
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) throws NumberFormatException {
				...
				try{
                                    ...
                                    Conn c = new Conn();
                                    String str = "update room set clean_status = '"+txt_Status.getText()+"' where roomnumber = "+s3;
                ...
                btnUpdate.setBounds(261, 300, 89, 23);
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                btnExit.setBounds(36, 300, 89, 23);
