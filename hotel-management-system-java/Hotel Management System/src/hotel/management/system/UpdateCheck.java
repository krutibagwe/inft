...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
            super("Check and Update Room Details");
		...
		lblNewLabel.setBounds(25, 88, 106, 14);
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) { 
				...
				String s2 = txt_ID.getText();  
                                ...
                                c.s.executeUpdate("update customer set number = '"+s2+"', name = '"+s3+"', checkintime = '"+s4+"', deposit = '"+s5+"' where room = '"+s1+"'");
